...
void solve()
{
   ...
   for (int i = 0; i < antennas.size(); i++)
   {
      for (int j = i + 1; j < antennas.size(); j++)
      {
         ...
         int antiNode_x1 = x1 - dx, antiNode_y1 = y1 - dy;
         int antiNode_x2 = x2 + dx, antiNode_y2 = y2 + dy;

         if ((antiNode_x1 >= 0 && antiNode_x1 < rows) && (antiNode_y1 >= 0 && antiNode_y1 < cols))
         {
            antiNodes.insert({antiNode_x1, antiNode_y1});
         }

         if ((antiNode_x2 >= 0 && antiNode_x2 < rows) && (antiNode_y2 >= 0 && antiNode_y2 < cols))
         {
